...
//     FirstName_val.value = name_val.value;
//     Email_val.value = email_val.value;
// });
...
$(function () {
  ...
  function i(t) {
    ...
    return (
      (u = n(100, 600)),
      (f =
        '<li class="review__item"><div class="review__user_photo"><img src="https://twowords.info/img/users/' +
        i +
